...
cpc_full = arm.read_netcdf(cpc_full_p[:18])
...
plt.plot(df_10.index[df_10['flag']>0.0],df_10['cpc'][df_10['flag']>0.0].values,'r.')
plt.yscale('log')
#%%
plt.plot(pred_f)
#%% Train
...
#%%
df_10.to_csv('ml_co_o3_flag_1029_1114.csv')
